...
if True:
    pt405 = cq.importers.importStep(fixpath('chase_dr/step/PT405.stp'))
...
a = (cq.Assembly()
     .add(dr, name='dr', color=cq.Color('green'))
     .add(pt405, name='pt405')
     .add(ovc, name='ovc', color=cq.Color(1,1,1,0.5))
     .add(collar, name='collar', color=cq.Color('red'))
     .add(p40K, name='40K plate', color=cq.Color('gold'))
     .add(t40K, name='40K tube', color=cq.Color(0,0,1,0.5))
     .add(p4K, name='4K plate', color=cq.Color('gold'))
     .add(t4K, name='4K tube', color=cq.Color(0,1,1,0.5))
     )
# a.solve()
